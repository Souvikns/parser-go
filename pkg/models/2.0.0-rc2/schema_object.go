...
type SchemaObject struct {
  ...
  Definitions map[string]CoreSchemaMetaMinusSchema `json:"definitions,omitempty"`
  Properties map[string]CoreSchemaMetaMinusSchema `json:"properties,omitempty"`
  PatternProperties map[string]CoreSchemaMetaMinusSchema `json:"patternProperties,omitempty"`
  ...
  AllOf []CoreSchemaMetaMinusSchema `json:"allOf,omitempty"`
  AnyOf []CoreSchemaMetaMinusSchema `json:"anyOf,omitempty"`
  OneOf []CoreSchemaMetaMinusSchema `json:"oneOf,omitempty"`
