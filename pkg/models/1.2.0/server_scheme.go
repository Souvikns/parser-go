...
var ServerSchemeValues = []any{"kafka","kafka-secure","amqp","amqps","mqtt","mqtts","secure-mqtt","ws","wss","stomp","stomps","jms","http","https"}
var ValuesToServerScheme = map[any]ServerScheme{
  ...
  ServerSchemeValues[ServerSchemeHttp]: ServerSchemeHttp,
  ServerSchemeValues[ServerSchemeHttps]: ServerSchemeHttps,
}
