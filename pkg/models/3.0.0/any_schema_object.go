...
type AnySchemaObject struct {
  ...
  Schema *AnySchema `json:"schema,omitempty"`
  ...
  AdditionalItems *AnySchema `json:"additionalItems,omitempty"`
  Items *JsonMinusSchemaMinusDraftMinus_07MinusSchemaItems `json:"items,omitempty"`
  MaxItems int `json:"maxItems,omitempty"`
  MinItems int `json:"minItems,omitempty"`
  UniqueItems bool `json:"uniqueItems,omitempty"`
  Contains *AnySchema `json:"contains,omitempty"`
  MaxProperties int `json:"maxProperties,omitempty"`
  MinProperties int `json:"minProperties,omitempty"`
  Required []string `json:"required,omitempty"`
  AdditionalProperties *AnySchema `json:"additionalProperties,omitempty"`
  ...
  PropertyNames *AnySchema `json:"propertyNames,omitempty"`
  ...
  ReservedIf *AnySchema `json:"if,omitempty"`
  Then *AnySchema `json:"then,omitempty"`
  ReservedElse *AnySchema `json:"else,omitempty"`
  AllOf []AnySchema `json:"allOf,omitempty"`
  AnyOf []AnySchema `json:"anyOf,omitempty"`
  OneOf []AnySchema `json:"oneOf,omitempty"`
  Not *AnySchema `json:"not,omitempty"`
