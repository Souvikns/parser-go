...
const (
  ChannelBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0 ChannelBindingsObjectKafkaBindingVersion = iota
  ChannelBindingsObjectKafkaBindingVersionNumber_0Dot_4Dot_0
...
var ChannelBindingsObjectKafkaBindingVersionValues = []any{"0.5.0","0.4.0","0.3.0"}
var ValuesToChannelBindingsObjectKafkaBindingVersion = map[any]ChannelBindingsObjectKafkaBindingVersion{
  ChannelBindingsObjectKafkaBindingVersionValues[ChannelBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0]: ChannelBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0,
