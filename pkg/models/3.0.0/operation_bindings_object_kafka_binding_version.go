...
const (
  OperationBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0 OperationBindingsObjectKafkaBindingVersion = iota
  OperationBindingsObjectKafkaBindingVersionNumber_0Dot_4Dot_0
...
var OperationBindingsObjectKafkaBindingVersionValues = []any{"0.5.0","0.4.0","0.3.0"}
var ValuesToOperationBindingsObjectKafkaBindingVersion = map[any]OperationBindingsObjectKafkaBindingVersion{
  OperationBindingsObjectKafkaBindingVersionValues[OperationBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0]: OperationBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0,
