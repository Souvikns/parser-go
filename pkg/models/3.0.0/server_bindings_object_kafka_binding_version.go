...
const (
  ServerBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0 ServerBindingsObjectKafkaBindingVersion = iota
  ServerBindingsObjectKafkaBindingVersionNumber_0Dot_4Dot_0
...
var ServerBindingsObjectKafkaBindingVersionValues = []any{"0.5.0","0.4.0","0.3.0"}
var ValuesToServerBindingsObjectKafkaBindingVersion = map[any]ServerBindingsObjectKafkaBindingVersion{
  ServerBindingsObjectKafkaBindingVersionValues[ServerBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0]: ServerBindingsObjectKafkaBindingVersionNumber_0Dot_5Dot_0,
